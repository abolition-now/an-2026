...
<Slider iiifContent="/an-2026/api/facet/subject/interviews.json" />

<Slider iiifContent="/api/facet/subject/abolition.json" />

<Slider iiifContent="/an-2026/api/facet/subject/punishment.json" />

<Slider iiifContent="/an-2026/api/facet/subject/worldingfutures.json" />

<Slider iiifContent="/an-2026/api/facet/creator/micah-bazant.json" />

<Slider iiifContent="/an-2026/api/facet/visualmotifs/hands.json" />

<Slider iiifContent="/an-2026/api/facet/visualmotifs/pigs.json" />

<Slider iiifContent="/an-2026/api/facet/visualmotifs/flora.json" />

<Slider iiifContent="/an-2026/api/facet/visualmotifs/fire.json" />

<Slider iiifContent="/an-2026/api/facet/subject/palestine.json" />

<Slider iiifContent="/an-2026/api/facet/medium/murals.json" />
